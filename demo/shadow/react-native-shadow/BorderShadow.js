      ...
      <View style={[{
        ...
        {(() => {
          switch (side) {
            case 'top':
              return [
                <Svg height={lineWidth} width={width + lineWidth} style={{
                  position: 'absolute',
                  top: (inset ? 0 : -lineWidth),
                }}>
                  <Defs>
                    <LinearGradient id="top" x1="0%" x2="0%" y1="100%" y2="0%">{linear('BorderTop')}</LinearGradient>
                    <LinearGradient id="top-inset" x1="0%" x2="0%" y1="0%"
                                    y2="100%">{linear('BorderTopInset')}</LinearGradient>
                  </Defs>
            ...
            case 'bottom':
              return [
                ...
                <Svg height={lineWidth} width={width + lineWidth} style={{
                  ...
                  <Defs>
                    <LinearGradient id="bottom" x1="0%" x2="0%" y1="0%"
                                    y2="100%">{linear('BorderBottom')}</LinearGradient>
                    <LinearGradient id="bottom-inset" x1="0%" x2="0%" y1="100%"
                                    y2="0%">{linear('BorderBottomInset')}</LinearGradient>
                  </Defs>
