...
export default class SideMenu extends React.Component {
  ...
  constructor(props: Props) {
    ...
    const initialMenuPositionMultiplier = -1;
  ...
  getContentView() {
    ...
    let overlay = (
      <Animated.View
        style={[StyleSheet.absoluteFill, {backgroundColor:'#333'}, opacitytransform]}
  ...
  render(): React.Element<void, void> {
    const boundryStyle =
      {width: this.props.openMenuOffset};
    ...
    const menu = (
      <Animated.View style={[styles.menu, boundryStyle, transformStyle]} {...this.responder.panHandlers}>
...
SideMenu.defaultProps = {
  ...
  children: null,
  menu: null,
  openMenuOffset: deviceScreen.width * (0.86), // meterial drawer width
